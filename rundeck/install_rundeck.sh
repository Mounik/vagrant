...
echo "Add rundeck.xavki dns"
sed -i s/localhost/rundeck.xavki/g /etc/rundeck/framework.properties
...
server {
  ...
  index index.html index.htm index.nginx-debian.html;
	access_log  /var/log/nginx/rundeck.xavki.access.log;
	error_log  /var/log/nginx/rundeck.xavki.access.log  crit;
	location / {
...
sed -i s/localhost/rundeck.xavki/g /etc/rundeck/rundeck-config.properties
