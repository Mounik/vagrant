...
output:
  sql_insert:
    driver: \"clickhouse\"
    dsn: \"clickhouse://xavki:password@clickhouse1:9000,clickhouse2:9000/helloworld\"
    table: \"table1\"
...
clickhouse-client -h clickhouse1 --user xavki --password password -q "CREATE DATABASE IF NOT EXISTS helloworld ON CLUSTER '{cluster}';"
clickhouse-client -h clickhouse1 --user xavki --password password -q "
